...
function createNewBlocks() {
     ...
     var  value;
     value = prompt("сколько блоков добавить на страницу, от 1 до 6?", 0);   
     if (value<7) {
	...
	function search() {
	var value;
	value = prompt("Поиск", 0);
	
var
el = document.getElementById("blocks").children[value-1]
if (el!==undefined) {el.style.border="7px solid red";
                }
                }
